...
<head>
    ...
    <title>Data Protection & Privacy Law | Trademark Nova</title>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6">
                                <figure class="aboutImg">
                                    <img src="assets/images/data-privacy-img1.webp" alt="">
            ...
            <section class="whatDifferent">
                <div class="container">
                    <div class="row align-items-center flex-row-reverse">
                        ...
                        <div class="col-md-5">
                            <img src="assets/images/data-privacy-img2.webp" alt="" class="rounded box-shadow">
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div class="container-fluid">
                    <div class="row align-items-center">
                        <div class="col-xl-6 px-0">
                            <img src="assets/images/data-privacy-img3.webp" alt="" class="w-100">
                        </div>
